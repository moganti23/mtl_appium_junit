 ...
 * @author Ross Rowe
 */
public class MobileTestLabTest {
    ...
    public static void setUp() throws Exception {
        // set up appium
        File appDir = new File("/Users/sriramangajala/Documents/Mobile Test Lab/DerivedData/Mobile Test Lab/Build/Products/Debug-iphonesimulator");
    ...
    public void OpenApp() throws Exception {
      ...
      //  button.click();
        ...
        System.out.println("text"+texts.getText());
      //  assertEquals(String.valueOf(values.get(0) + values.get(1)), texts.getScreenText());
    }
...
//        assertEquals("Cool title", alert.getScreenText());
//        alert.accept();
//    }
//
//    @Test
...
//        WebElement button = driver.findElement(By.xpath("//button[1]"));
//        assertEquals("ComputeSumButton", button.getScreenText());
//    }
//
//    @Test
...
//        text.clear();
//
//        assertEquals("", text.getScreenText());
//    }
//
//    @Test
...
//        assertEquals(String.valueOf(number), sumLabel.getScreenText());
//    }
//
//    @Test
...
//        assertEquals(String.valueOf(number), texts.getScreenText());
//    }
//
//    @Test
